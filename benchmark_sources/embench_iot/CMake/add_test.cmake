...
macro(add_Benchmark TEST)
    ...
    if(TRACE)
        message("${BINARY_DIR}/last_test_sig.vcd")
        set(MEM_TRACE_ARGS "${BINARY_DIR}/last_test_mem.csv")
        set(VCD_TRACE_ARGS "${BINARY_DIR}/last_test_sig.vcd")
    ...
    add_test(NAME ${TEST_NAME} 
             COMMAND ./${VERILATOR_MODEL_DIR}/build/verilated_model ${BINARY_DIR}/prog_${TEST_NAME}.txt ${MEM_W} 4194304 ${MEM_LATENCY} 1 ${TEST_NAME} ${VREG_W} 0 ${VCD_TRACE_ARGS}  #TODO: PASS ALL THESE ARGUMENTS IN FROM USER
